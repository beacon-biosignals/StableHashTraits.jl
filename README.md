...
> bug. Versions 1.1.4 are to be retroactively marked as incompatible with Julia 1.10. >
...
> Julia 1.6 - 1.10. (The cause of this bug was the change in the string representation named
> tuples, so any hashed objects that include the type of a named tuple changed).
